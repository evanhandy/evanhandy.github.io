$.getJSON("/scripts/data.json", function(data) {
    ...
    screenshotH.html("<img src='" + screenshot_url_sml + "' srcset='" + screenshot_url_sml + " 500w, " + screenshot_url_med + " 750w, " + screenshot_url_big + " 1200w' alt='Screenshot of the " + screenshot_title + "' title='" + screenshot_title + "'>");
});
